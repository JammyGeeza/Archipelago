...
class StacklandsWorld(World):
    ...
    def fill_slot_data(self) -> Dict[str, Any]:
        slot_data = {}
        slot_data.update(self.options.as_dict("board_expansion_mode", "board_expansion_amount", "death_link", "goal", "mobsanity", "moon_length", "packsanity", "pausing", "quest_checks", "sell_cards_trap_amount", "start_inventory"))

...
#region Mainland Quests
    ...
    LocationData("Grow a Berry Bush using Soil"                         , RegionFlags.Mainland      , ProgressionPhase.General     , CheckType.Check    , OptionFlags.NONE           , LocationProgressType.PRIORITY), # <- Help steer progression
    ...
    LocationData("Create Offspring"                                     , RegionFlags.Mainland      , ProgressionPhase.PhaseOne     , CheckType.Check    , OptionFlags.NONE           , LocationProgressType.PRIORITY),  # <- Help steer progression
    ...
    LocationData("Find a mysterious artifact"                           , RegionFlags.Mainland      , ProgressionPhase.PhaseTwo     , CheckType.Check    , OptionFlags.NONE           , LocationProgressType.DEFAULT ),
    ...
    LocationData("Kill a Skeleton"                                      , RegionFlags.Mainland      , ProgressionPhase.General     , CheckType.Check    , OptionFlags.NONE           , LocationProgressType.DEFAULT ),
    ...
    LocationData("Cook Raw Meat"                                        , RegionFlags.Mainland      , ProgressionPhase.PhaseOne     , CheckType.Check    , OptionFlags.NONE           , LocationProgressType.DEFAULT ),
    ...
    # 'Discovery' Category
    LocationData("Explore a Forest"                                     , RegionFlags.Mainland      , ProgressionPhase.General     , CheckType.Check    , OptionFlags.NONE           , LocationProgressType.DEFAULT ),
    LocationData("Explore a Mountain"                                   , RegionFlags.Mainland      , ProgressionPhase.General     , CheckType.Check    , OptionFlags.NONE           , LocationProgressType.DEFAULT ),
    LocationData("Open a Treasure Chest"                                , RegionFlags.Mainland      , ProgressionPhase.General     , CheckType.Check    , OptionFlags.NONE           , LocationProgressType.DEFAULT ),
    LocationData("Find a Graveyard"                                     , RegionFlags.Mainland      , ProgressionPhase.General      , CheckType.Check    , OptionFlags.NONE           , LocationProgressType.DEFAULT ),
    LocationData("Get a Dog"                                            , RegionFlags.Mainland      , ProgressionPhase.General     , CheckType.Check    , OptionFlags.NONE           , LocationProgressType.DEFAULT ),
    LocationData("Train an Explorer"                                    , RegionFlags.Mainland      , ProgressionPhase.General     , CheckType.Check    , OptionFlags.NONE           , LocationProgressType.DEFAULT ),
    LocationData("Buy something from a Travelling Cart"                 , RegionFlags.Mainland      , ProgressionPhase.General     , CheckType.Check    , OptionFlags.NONE           , LocationProgressType.EXCLUDED), # <- Is both RNG and a waiting game
    ...
    LocationData("Buy the Reap & Sow Pack"                              , RegionFlags.Mainland      , ProgressionPhase.General      , CheckType.Check    , OptionFlags.NONE           , LocationProgressType.DEFAULT ),
    LocationData("Buy the Curious Cuisine Pack"                         , RegionFlags.Mainland      , ProgressionPhase.General     , CheckType.Check    , OptionFlags.NONE           , LocationProgressType.DEFAULT ),
    LocationData("Buy the Logic and Reason Pack"                        , RegionFlags.Mainland      , ProgressionPhase.General     , CheckType.Check    , OptionFlags.NONE           , LocationProgressType.DEFAULT ),
    LocationData("Buy the The Armory Pack"                              , RegionFlags.Mainland      , ProgressionPhase.General      , CheckType.Check    , OptionFlags.NONE           , LocationProgressType.DEFAULT ),
    LocationData("Buy the Explorers Pack"                               , RegionFlags.Mainland      , ProgressionPhase.General     , CheckType.Check    , OptionFlags.NONE           , LocationProgressType.DEFAULT ),
    LocationData("Buy the Order and Structure Pack"                     , RegionFlags.Mainland      , ProgressionPhase.General     , CheckType.Check    , OptionFlags.NONE           , LocationProgressType.DEFAULT ),

    LocationData("Buy 5 Booster Packs"                                  , RegionFlags.Mainland      , ProgressionPhase.General      , CheckType.Check    , OptionFlags.NONE           , LocationProgressType.DEFAULT ),
    LocationData("Buy 10 Booster Packs"                                 , RegionFlags.Mainland      , ProgressionPhase.General      , CheckType.Check    , OptionFlags.NONE           , LocationProgressType.DEFAULT ),
    LocationData("Buy 25 Booster Packs"                                 , RegionFlags.Mainland      , ProgressionPhase.General     , CheckType.Check    , OptionFlags.NONE           , LocationProgressType.DEFAULT ),

    LocationData("Sell 5 Cards"                                         , RegionFlags.Mainland      , ProgressionPhase.General      , CheckType.Check    , OptionFlags.NONE           , LocationProgressType.DEFAULT ), 
    LocationData("Sell 10 Cards"                                        , RegionFlags.Mainland      , ProgressionPhase.General      , CheckType.Check    , OptionFlags.NONE           , LocationProgressType.DEFAULT ), 
    LocationData("Sell 25 Cards"                                        , RegionFlags.Mainland      , ProgressionPhase.General      , CheckType.Check    , OptionFlags.NONE           , LocationProgressType.DEFAULT ), 
    ...
    LocationData("Make an Iron Shield"                                  , RegionFlags.Mainland      , ProgressionPhase.General     , CheckType.Check    , OptionFlags.NONE           , LocationProgressType.DEFAULT ),
    ...
    LocationData("Make a Sword"                                         , RegionFlags.Mainland      , ProgressionPhase.General     , CheckType.Check    , OptionFlags.NONE           , LocationProgressType.DEFAULT ),
    LocationData("Make Throwing Stars"                                  , RegionFlags.Mainland      , ProgressionPhase.General     , CheckType.Check    , OptionFlags.NONE           , LocationProgressType.DEFAULT ),

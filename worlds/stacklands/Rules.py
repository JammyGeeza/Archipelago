...
#region 'Exits'
   ...
   if mainland_selected:
      ...
      set_rule(world.get_location("Train a Wizard", player),
               lambda state:  # Phase Two
                  state.can_reach_location("Make a Magic Wand", player))
      ...
      set_rule(world.get_location("Have 30 Coins", player),
               lambda state:  # Phase One
                  state.can_reach_location("Build a Coin Chest", player)
                  and state.sl_has_pack("Seeking Wisdom", player))
   ...
   set_rule(world.get_location("Goal Complete", player),
            lambda state:
               (not mainland_selected or state.has("Demon", player))
               and (not forest_selected or state.has("Wicked Witch", player))
               and (not island_selected or state.has("Demon Lord", player)))

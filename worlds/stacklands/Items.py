...
#region Mainland Items
    ...
    # Booster Packs
    ItemData("Humble Beginnings Booster Pack",      1,    ItemClassification.progression | ItemClassification.useful,     ItemType.Mainland),
    ItemData("Seeking Wisdom Booster Pack",         1,    ItemClassification.progression | ItemClassification.useful,     ItemType.Mainland),
    ItemData("Reap & Sow Booster Pack",             1,    ItemClassification.progression | ItemClassification.useful,     ItemType.Mainland),
    ItemData("Curious Cuisine Booster Pack",        1,    ItemClassification.progression | ItemClassification.useful,     ItemType.Mainland),
    ItemData("Logic and Reason Booster Pack",       1,    ItemClassification.progression | ItemClassification.useful,     ItemType.Mainland),
    ItemData("The Armory Booster Pack",             1,    ItemClassification.progression | ItemClassification.useful,     ItemType.Mainland),
    ItemData("Explorers Booster Pack",              1,    ItemClassification.progression | ItemClassification.useful,     ItemType.Mainland),
    ItemData("Order and Structure Booster Pack",    1,    ItemClassification.progression | ItemClassification.useful,     ItemType.Mainland),
    ...
    ItemData("Idea: Bone Spear",                    1,    ItemClassification.useful,                                      ItemType.Mainland),
    ...
    ItemData("Idea: Brick",                         1,    ItemClassification.progression | ItemClassification.useful,     ItemType.Mainland),
    ...
    ItemData("Idea: Chainmail Armor",               1,    ItemClassification.useful,                                      ItemType.Mainland),
    ...
    ItemData("Idea: Garden",                        1,    ItemClassification.useful,                                      ItemType.Mainland),
    ItemData("Idea: Growth",                        1,    ItemClassification.progression | ItemClassification.useful,     ItemType.Mainland),
    ...
    ItemData("Idea: House",                         1,    ItemClassification.progression | ItemClassification.useful,     ItemType.Mainland),
    ItemData("Idea: Iron Bar",                      1,    ItemClassification.progression | ItemClassification.useful,     ItemType.Mainland),
    ...
    ItemData("Idea: Magic Blade",                   1,    ItemClassification.useful,                                      ItemType.Mainland),
    ...
    ItemData("Idea: Magic Staff",                   1,    ItemClassification.useful,                                      ItemType.Mainland),
    ...
    ItemData("Idea: Offspring",                     1,    ItemClassification.progression | ItemClassification.useful,     ItemType.Mainland),
    ItemData("Idea: Pickaxe",                       1,    ItemClassification.useful,                                      ItemType.Mainland),
    ItemData("Idea: Plank",                         1,    ItemClassification.progression | ItemClassification.useful,     ItemType.Mainland),
    ...
    ItemData("Idea: Sawmill",                       1,    ItemClassification.progression,                                 ItemType.Mainland),
    ItemData("Idea: Shed",                          1,    ItemClassification.progression | ItemClassification.useful,     ItemType.Mainland),
    ItemData("Idea: Slingshot",                     1,    ItemClassification.progression,                                 ItemType.Mainland),
    ItemData("Idea: Smelter",                       1,    ItemClassification.progression | ItemClassification.useful,     ItemType.Mainland),
    ItemData("Idea: Smithy",                        1,    ItemClassification.progression | ItemClassification.useful,     ItemType.Mainland),
    ...
    ItemData("Idea: Stick",                         1,    ItemClassification.progression | ItemClassification.useful,     ItemType.Mainland),
    ItemData("Idea: Stove",                         1,    ItemClassification.progression,                                 ItemType.Mainland),
...
#region The Dark Forest Items
    ...
    ItemData("Idea: Stable Portal",                 1,    ItemClassification.progression | ItemClassification.useful,     ItemType.DarkForest),
